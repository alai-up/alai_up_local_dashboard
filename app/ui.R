  ...
  dashboardSidebar(
    ...
    sidebarMenu(id='sidebar',
                ...
                menuItem(text = strong("Clinic Demographics"),
                         ...
                         menuItem(text = "By LAI ART use",
                                  tabName = "demo_by_lai")),
                menuItem(strong("LAI ART indicators"),tabName = 'page1',
                ...
                conditionalPanel("input.sidebar === 'time_trends_page'",
                                 ...
                                 selectInput(
                                  ...
                                  choices = c(1,3,6),
                                  selected = 1),
                                 checkboxInput("show_time_trend_var_filter", "Filter by second variable (optional)", value = FALSE),
